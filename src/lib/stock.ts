...
export async function decrementarStockProducto(
  ...
  for (let intento = 0; intento < MAX_RETRIES; intento++) {
    ...
    console.log(`⚠️ CAS fallido producto ${productoId}, reintentando (${intento + 1}/${MAX_RETRIES})`);
  }
...
export async function decrementarStockVariante(
  ...
  for (let intento = 0; intento < MAX_RETRIES; intento++) {
    ...
    console.log(`⚠️ CAS fallido variante ${varianteId}, reintentando (${intento + 1}/${MAX_RETRIES})`);
  }
